...
module Apifreaks
  module Types
    class ZipcodeSearchByRadiusResponse < Internal::Types::Model
      ...
      field :results, -> { Internal::Types::Array[Apifreaks::Types::ZipcodeSearchByRadiusResponseResultsItem] }, optional: true, nullable: false
    end
  end
end
