...
module Apifreaks
  module Types
    class DomainDNSLookupResponseDNSRecordsItemAdmin < Internal::Types::Model
      field :name, -> { String }, optional: false, nullable: false

      field :type, -> { Integer }, optional: false, nullable: false

      field :dns_type, -> { Apifreaks::Types::DomainDNSLookupResponseDNSRecordsItemAdminDNSType }, optional: false, nullable: false, api_name: "dnsType"
