...
module Apifreaks
  module Types
    # Daily forecast data
    class WeatherForecastResponseForecastValueDaily < Internal::Types::Model
      ...
      field :uv_index_max, -> { Integer }, optional: true, nullable: false

      field :uv_index_clear_sky_max, -> { Integer }, optional: true, nullable: false

      field :rain_sum, -> { Integer }, optional: true, nullable: false

      field :showers_sum, -> { Integer }, optional: true, nullable: false

      field :snowfall_sum, -> { Integer }, optional: true, nullable: false

      field :precipitation_sum, -> { Integer }, optional: true, nullable: false

      field :precipitation_probability_mean, -> { Integer }, optional: true, nullable: false
      ...
      field :visibility_mean, -> { Integer }, optional: true, nullable: false
