...
module Apifreaks
  module Types
    class DomainWhoisLookupResponseRegistryData < Internal::Types::Model
      ...
      field :domain_registered, -> { Apifreaks::Types::DomainWhoisLookupResponseRegistryDataDomainRegistered }, optional: true, nullable: false
      ...
      field :domain_registrar, -> { Apifreaks::Types::DomainWhoisLookupResponseRegistryDataDomainRegistrar }, optional: true, nullable: false
    end
  end
end
