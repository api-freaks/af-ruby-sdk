...
module Apifreaks
  module Types
    class BulkGeolocationLookupResponseItemLocation < Internal::Types::Model
      ...
      field :country_capital, -> { String }, optional: true, nullable: false
      ...
      field :dma_code, -> { String }, optional: true, nullable: false
      ...
      field :country_flag, -> { String }, optional: true, nullable: false

      field :geoname_id, -> { String }, optional: true, nullable: false

      field :country_emoji, -> { String }, optional: true, nullable: false
    end
  end
end
