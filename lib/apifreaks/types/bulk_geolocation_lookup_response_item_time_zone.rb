...
module Apifreaks
  module Types
    class BulkGeolocationLookupResponseItemTimeZone < Internal::Types::Model
      ...
      field :dst_start, -> { Apifreaks::Types::BulkGeolocationLookupResponseItemTimeZoneDstStart }, optional: true, nullable: false

      field :dst_end, -> { Apifreaks::Types::BulkGeolocationLookupResponseItemTimeZoneDstEnd }, optional: true, nullable: false
    end
  end
end
