...
module Apifreaks
  module Types
    class DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryData < Internal::Types::Model
      ...
      field :domain_registered, -> { Apifreaks::Types::DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistered }, optional: true, nullable: false
      ...
      field :domain_registrar, -> { Apifreaks::Types::DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistrar }, optional: true, nullable: false
    end
  end
end
