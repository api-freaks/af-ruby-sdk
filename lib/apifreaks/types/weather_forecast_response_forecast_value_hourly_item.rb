...
module Apifreaks
  module Types
    class WeatherForecastResponseForecastValueHourlyItem < Internal::Types::Model
      ...
      field :precipitation_probability, -> { Integer }, optional: true, nullable: false

      field :rain, -> { Integer }, optional: true, nullable: false

      field :showers, -> { Integer }, optional: true, nullable: false
      ...
      field :visibility, -> { Integer }, optional: true, nullable: false
