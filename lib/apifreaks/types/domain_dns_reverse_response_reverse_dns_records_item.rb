...
module Apifreaks
  module Types
    class DomainDNSReverseResponseReverseDNSRecordsItem < Internal::Types::Model
      ...
      field :dns_records, -> { Internal::Types::Array[Apifreaks::Types::DomainDNSReverseResponseReverseDNSRecordsItemDNSRecordsItem] }, optional: false, nullable: false, api_name: "dnsRecords"
    end
  end
end
