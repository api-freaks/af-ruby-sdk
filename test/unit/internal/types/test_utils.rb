...
describe Apifreaks::Internal::Types::Utils do
  Utils = Apifreaks::Internal::Types::Utils

  module TestUtils
    class M < Apifreaks::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Apifreaks::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Apifreaks::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Apifreaks::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Apifreaks::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Apifreaks::Internal::Types::Array[String]
      ModelArray = -> { Apifreaks::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Apifreaks::Internal::Types::Array[TestUtils::U] }
