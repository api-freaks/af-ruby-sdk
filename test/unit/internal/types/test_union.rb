...
describe Apifreaks::Internal::Types::Union do
  class Rectangle < Apifreaks::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Apifreaks::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Apifreaks::Internal::Types::Model
