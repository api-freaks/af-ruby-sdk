...
describe Apifreaks::Internal::Types::Model do
  ...
  class ExampleModel < Apifreaks::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Apifreaks::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Apifreaks::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Apifreaks::Internal::Types::Model
