...
require_relative "lib/apifreaks/version"
...
Gem::Specification.new do |spec|
  spec.name = "apifreaks"
  spec.authors = ["Apifreaks"]
  spec.version = Apifreaks::VERSION
  spec.summary = "Ruby client library for the Apifreaks API"
  spec.description = "The Apifreaks Ruby library provides convenient access to the Apifreaks API from Ruby."
